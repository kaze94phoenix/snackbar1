 ...
 * @author Gaara-X
 */
public class RelatorioGestaoI extends JPanel {
    public RelatorioGestaoI(){
        criacao();
    }
   ...
   public void criacao(){
       ...
       //pnPrincipal.setBorder(borda);
        try {
            ...
            tabela= new JTable(Controle.Modelos.modeloRelatGestao());
        } catch (Exception ex) {
            Logger.getLogger(RelatorioGestaoI.class.getName()).log(Level.SEVERE, null, ex);
        }
